<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\phpStudy\PHPTutorial\WWW\junyue\public/../app/view\storage\create.html";i:1514978670;}*/ ?>
...
<form class="validate add-form" novalidate="novalidate">
	...
	<div class="row">
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="sn" placeholder="仓库编号" value="SN<?php echo date('Ymdhis',time()); ?><?php echo rand(10000,99999); ?>">
			</div>	
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="form-group">
				<label for="field-3" class="control-label">仓库地址</label>
