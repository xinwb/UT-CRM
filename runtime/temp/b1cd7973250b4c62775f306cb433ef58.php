<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\phpStudySetup\PHPTutorial\WWW\junyue\public/../app/view\login\index.html";i:1520045417;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                ...
                <form method="post" role="form" id="login" class="login-form fade-in-effect">
                    ...
                    <div class="login-header">
                        <a href="dashboard-1.html" class="logo">
                            <img src="__JUNYUE__/static/images/logo@2x.png" alt="" width="80" />
                            <span>登录中心</span>
                        </a>
...
<!--                 <div class="external-login">
    ...
    <script src="__JUNYUE__/static/js/jquery.validate.js"></script>
    <script src="__JUNYUE__/static/js/toastr/toastr.min.js"></script>
