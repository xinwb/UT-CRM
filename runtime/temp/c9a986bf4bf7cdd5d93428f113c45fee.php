...
<div class="page-title">  
    ...
    <div class="breadcrumb-env pull-left">
        ...
        <ol class="breadcrumb bc-1">
            <li>
                <a href="<?php echo url('Unit/index'); ?>"><i class="fa-home"></i>首页</a>
            </li>
            <li>
                <a href="">基本设置</a>
             </li>
                    ...
                    <div class="btn-toolbar">
                        ...
                        <form class="form-inline" style="margin-bottom:15px;" class="search-tool">
                            <span>
                                ...
                                <input type="text" class="form-control" placeholder="单位名称" name="name" value="<?php echo \think\Request::instance()->get('name'); ?>"> 
                            </span>
                            
                            <span style="margin-left: 15px;">
                                <label class="control-label">单位编号</label>      
                                <input type="text" class="form-control" placeholder="单位编号" name="sn" value="<?php echo \think\Request::instance()->get('sn'); ?>">
                            </span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:;" 
                                        ...
                                        onclick="editAjaxModal('<?php echo url('/Unit/edit/id/'.$user->id); ?>')" >
                                        编辑
                                    </a>
...
<script type="text/javascript">
    ...
    function add_from(){
        ...
        $.post("<?php echo url('Unit/save'); ?>", res,function(data){
            if( data.error>0 ){
    ...
    function edit_from(){
        ...
        $.post("<?php echo url('Unit/update'); ?>", res,function(data){
            if( data.error>0 ){
                toastr.error( data.msg );  
            }else{
                toastr.success( data.msg );  
    ...
    function del(id){
        if( confirm("确定要删除吗？") ){
            $.post("<?php echo url('Unit/delete'); ?>", {id:id},function(data){
                if( data.error>0 ){
                    toastr.error( data.msg );  
                }else{
                    toastr.success( data.msg );  
