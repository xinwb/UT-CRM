...
<form class="validate edit_from" role="form" action="<?php echo url('user/edit'); ?>" method="post">
	...
	<div class="row">
		...
		<div class="col-md-3">
			<div class="form-group">
				...
				<input type="text" class="form-control" name="username" placeholder="登录账号" value="<?php echo $user['username']; ?>" id="username" required="" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')">
			</div>	
		</div>
		<div class="col-md-3">
			<div class="form-group">
				<label for="field-2" class="control-label">密码</label>
				<input type="text" class="form-control" name="password" placeholder="密码" value="" id="password" required="">
			</div>	
		</div>
		<div class="col-md-3">
		</div>
	...
	<div class="row">	
		...
		<div class="col-md-3">
			<div class="form-group">
				...
				<input type="text" class="form-control" name="phone" placeholder="联系电话" value="<?php echo $user['phone']; ?>" id="phone" required="" onkeyup="this.value=this.value.replace(/\D/g,'')">
			</div>	
		</div>
		<div class="col-md-3">
			<div class="form-group">
				...
				<input type="text" class="form-control" name="truename" placeholder="姓名" value="<?php echo $user['truename']; ?>" id="truename" required="">
			</div>	
		</div>
		<div class="col-md-3">
		</div>
	...
	<div class="row">	
		...
		<div class="col-md-6">
			<div class="form-group">
				...
				<input type="text" class="form-control" name="eamil" placeholder="邮箱" value="<?php echo $user['eamil']; ?>" id="eamil" required="">
			</div>	
		</div>
		<div class="col-md-3">
		</div>
	...
	<div class="form-group">
        <div class="col-sm-offset-3 col-sm-6">
            <button type="submit" class="btn btn-default btn-block">保存信息</button>
        </div>
    </div>
