<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:76:"/Applications/XAMPP/xamppfiles/htdocs/jxc/public/../app/view/user/index.html";i:1520818811;s:62:"/Applications/XAMPP/xamppfiles/htdocs/jxc/app/view/layout.html";i:1514905474;s:69:"/Applications/XAMPP/xamppfiles/htdocs/jxc/app/view/public/header.html";i:1520909988;s:67:"/Applications/XAMPP/xamppfiles/htdocs/jxc/app/view/public/menu.html";i:1520487435;s:69:"/Applications/XAMPP/xamppfiles/htdocs/jxc/app/view/public/footer.html";i:1520314781;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="page-title">  
    ...
    <div class="breadcrumb-env pull-left">
        ...
        <ol class="breadcrumb bc-1">
            <li>
                <a href="<?php echo url('Index/index'); ?>"><i class="fa-home"></i>首页</a>
            </li>
            <li>
                <a href="">员工管理</a>
             </li>
            ...
            <div class="panel panel-default">
                <div class="panel-heading btn-toolbar">
                    ...
                    <div class="btn-group focus-btn-group">
                        <button class="btn btn-default btn-primary" onClick="javascript:window.location.href = '<?php echo url('create'); ?>'">
...
<!--                     <div class="panel-options pull-right">
                    ...
                    <div class="btn-group dropdown-btn-group pull-right">
                        ...
                        <form action="<?php echo url('Excel/userInto'); ?>" enctype="multipart/form-data" method="post">
                            <input  type="file" class="btn btn-default" name="file_stu"/>
                            <input type="submit" class="btn btn-default" value="导入" />
                        </form>
                        <form action="<?php echo url('Excel/userExport'); ?>" enctype="multipart/form-data" method="post" >
                    ...
                    <table class="table table-bordered table-striped" id="example-2">
                        ...
                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td> <?php echo $user['eamil']; ?> </td>
                                <!-- <td> <?php echo $user['status']==0?'正常':'禁用'; ?> </td> -->
                                <td>
                                    <a href="<?php echo url('edit',array('id'=>$user['id'])); ?>" 
...
<script type="text/javascript">
    ...
    function add_from(){
        ...
        $.post("<?php echo url('User/save'); ?>", res,function(data){
            if( data.error>0 ){
    ...
    function edit_from(){
        ...
        $.post("<?php echo url('User/update'); ?>", res,function(data){
            if( data.error>0 ){
                toastr.error( data.msg );  
            }else{
                toastr.success( data.msg );  
    ...
    function del(id){
        if( confirm("确定要删除吗？") ){
            $.post("<?php echo url('User/delete'); ?>", {id:id},function(data){
                if( data.error>0 ){
                    toastr.error( data.msg );  
                }else{
                    toastr.success( data.msg );  
