<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:80:"D:\phpStudySetup\PHPTutorial\WWW\junyue\public/../app/view\outstorage\index.html";i:1520046377;s:60:"D:\phpStudySetup\PHPTutorial\WWW\junyue\app\view\layout.html";i:1514905474;s:67:"D:\phpStudySetup\PHPTutorial\WWW\junyue\app\view\public\header.html";i:1520045239;s:65:"D:\phpStudySetup\PHPTutorial\WWW\junyue\app\view\public\menu.html";i:1514905474;s:67:"D:\phpStudySetup\PHPTutorial\WWW\junyue\app\view\public\footer.html";i:1520043973;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
				...
				<header class="logo-env">
					...
					<div class="logo">
						<a href="dashboard-1.html" class="logo-expanded">
							<img src="__JUNYUE__/static/images/logo@2x.png" width="80" alt="" />
						</a>
						
						<a href="dashboard-1.html" class="logo-collapsed">
							<img src="__JUNYUE__/static/images/logo-collapsed@2x.png" width="40" alt="" />
						</a>
					</div>
			...
			<nav class="navbar user-info-navbar" role="navigation">
				...
				<ul class="user-info-menu right-links list-inline list-unstyled">
					...
					<li class="dropdown user-profile">
						<a href="#" data-toggle="dropdown">
							<img src="__JUNYUE__/static/images/user-4.png" alt="user-image" class="img-circle img-inline userpic-32" width="28" />
							<span>
...
<div class="page-title">
    <div class="breadcrumb-env pull-left">
        <ol class="breadcrumb bc-1">
            <li>
                <a href="<?php echo url('Outstorage/index'); ?>"><i class="fa-home"></i>首页</a>
            </li>
            <li>
                <a href="">基本设置</a>
             </li>
                ...
                <div class="panel-body">
                    ...
                    <div class="btn-toolbar">
                        ...
                        <form class="form-inline" style="margin-bottom:15px;" class="search-tool">
                            <span>
                                <label class="control-label">制单者</label>
                                <input type="text" class="form-control" placeholder="制单者" name="author" value="<?php echo \think\Request::instance()->get('author'); ?>">
                            </span>
                            <span style="margin-left: 15px;">
                                <label class="control-label">出库编号</label>
                                <input type="text" class="form-control" placeholder="出库编号" name="sn" value="<?php echo \think\Request::instance()->get('sn'); ?>">
                            </span>
                            ...
                            <span style="margin-left: 15px;">
                                ...
                                <select class="form-control" name="type">
                                    <option value=""
                                        <?php if(\think\Request::instance()->get('type') == ' '): ?> selected="selected" <?php endif; ?>
                                    >全部类型</option>
                                    <option value="采购出库"
                                        <?php if(\think\Request::instance()->get('type') == '采购出库'): ?> selected="selected" <?php endif; ?>
                                    >采购出库</option>
                                    <option value="销售退货"
                                        <?php if(\think\Request::instance()->get('type') == '销售退货'): ?> selected="selected" <?php endif; ?>
                                    >销售退货</option>
                                </select>
                            </span>
...
<!--                                     <a href="javascript:;" 
                                        ...
                                        onclick="editAjaxModal('<?php echo url('/Outstorage/edit/id/'.$vo->id); ?>')" >
                                        编辑
                                    </a> -->

                                    <a href="<?php echo url('/Outstorage/prints/id/'.$vo->id); ?>" target="_blank" class="btn btn-secondary btn-sm btn-icon icon-left">
                                        打印
                                    </a>

                                    <a href="javascript:;" class="btn btn-secondary btn-sm btn-icon icon-left" onclick="showModal('<?php echo url('/Outstorage/show/id/'.$vo->id); ?>')">
                                        查看
                                    </a>

                                    <a href="javascript:;" class="btn btn-danger btn-sm btn-icon icon-left" onclick="del('<?php echo $vo['id']; ?>')">
                                        删除
                                    </a>
...
<script type="text/javascript">
    ...
    function showAjaxModal(){
        ...
        jQuery.ajax({
            url: "<?php echo url('Outstorage/create'); ?>",
    ...
    function add_from(){
        ...
        $.post("<?php echo url('Outstorage/save'); ?>", res,function(data){
            if( data.error>0 ){
    ...
    function edit_from(){
        ...
        $.post("<?php echo url('Outstorage/update'); ?>", res,function(data){
            if( data.error>0 ){
                toastr.error( data.msg );  
            }else{
                toastr.success( data.msg );  
    ...
    function del(id){
        if( confirm("确定要删除吗？") ){
            $.post("<?php echo url('Outstorage/delete'); ?>", {id:id},function(data){
                if( data.error>0 ){
                    toastr.error( data.msg );  
                }else{
                    toastr.success( data.msg );  
