<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\phpStudy\PHPTutorial\WWW\junyue\public/../app/view\login\index.html";i:1520319949;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                ...
                <form method="post" role="form" id="login" class="login-form fade-in-effect">
                    ...
                    <div class="login-header">
                        <a href="dashboard-1.html" class="logo">
                            <img src="__JUNYUE__/static/images/logo@2x.png" alt="" />
                            <span>登录中心</span>
                        </a>
