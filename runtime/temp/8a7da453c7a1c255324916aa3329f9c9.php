<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"D:\phpStudy\WWW\jxc\public/../app/view\product\create.html";i:1520476417;}*/ ?>
...
<form class="validate add-form" novalidate="novalidate">
	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group">
				...
				<input type="text" class="form-control" name="cjsn" placeholder="厂家编号" value="">
				<!-- value="<?php echo uniqid(); ?>" -->
			</div>
		</div>
		<div class="col-md-6">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="form-group">
				<label for="field-2" class="control-label">单价</label>
