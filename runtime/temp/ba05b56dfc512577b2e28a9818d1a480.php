<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\phpStudySetup\PHPTutorial\WWW\junyue\public/../app/view\product\edit.html";i:1514978670;}*/ ?>
...
<form class="validate edit_from" novalidate="novalidate">
	...
	<div class="row">	
		<div class="col-md-6">
			<div class="form-group">
				<label for="field-2" class="control-label">产品编号</label>
				<input type="text" class="form-control" name="sn" placeholder="产品编号" value="<?php echo $info['sn']; ?>">
				<input type="hidden" name="id" value="<?php echo $info['id']; ?>">
			</div>	
		</div>
		<div class="col-md-6">
			<div class="form-group">
				<label for="field-2" class="control-label">产品名称</label>
				<input type="text" class="form-control" name="name" placeholder="产品名称" value="<?php echo $info['name']; ?>">
			</div>	
		</div>
	</div>
	...
	<div class="row">	
		...
		<div class="col-md-6">
			<div class="form-group">
				<label for="field-2" class="control-label">内部编号</label>
				
				<input type="text" class="form-control" name="nbsn" placeholder="内部编号" value="<?php echo $info['nbsn']; ?>">
			</div>	
		</div>
	</div>
	...
	<div class="row">	
		<div class="col-md-6">
			<div class="form-group">
				<label for="field-2" class="control-label">产品规格</label>
				
				<input type="text" class="form-control" name="spec" placeholder="产品规格" value="<?php echo $info['spec']; ?>">
			</div>	
		</div>
		<div class="col-md-6">
			<div class="form-group">
				<label for="field-2" class="control-label">产品价格</label>
				
				<input type="text" class="form-control" name="price" placeholder="产品价格" value="<?php echo $info['price']; ?>">
			</div>	
		</div>
	</div>
