...
<div class="page-title">
    ...
    <div class="breadcrumb-env pull-left">
        ...
        <ol class="breadcrumb bc-1">
            <li>
                <a href="<?php echo url('Storage/index'); ?>"><i class="fa-home"></i>首页</a>
            </li>
            <li>
                <a href="">基本设置</a>
             </li>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:;" 
                                        ...
                                        onclick="editAjaxModal('<?php echo url('/Storage/edit/id/'.$user->id); ?>')" >
                                        编辑
                                    </a>
...
<script type="text/javascript">
    ...
    function showAjaxModal(){
        ...
        jQuery.ajax({
            url: "<?php echo url('Storage/create'); ?>",
    ...
    function add_from(){
        ...
        $.post("<?php echo url('Storage/save'); ?>", res,function(data){
            if( data.error>0 ){
    ...
    function edit_from(){
        ...
        $.post("<?php echo url('Storage/update'); ?>", res,function(data){
            if( data.error>0 ){
                toastr.error( data.msg );  
            }else{
                toastr.success( data.msg );  
    ...
    function del(id){
        if( confirm("确定要删除吗？") ){
            $.post("<?php echo url('Storage/delete'); ?>", {id:id},function(data){
                if( data.error>0 ){
                    toastr.error( data.msg );  
                }else{
                    toastr.success( data.msg );  
