<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\phpStudySetup\PHPTutorial\WWW\junyue\public/../app/view\supplier\create.html";i:1514978670;}*/ ?>
...
<form class="validate add-form" novalidate="novalidate">
	...
	<div class="row">
		<div class="col-md-6">
			...
			<div class="form-group">
				<label for="field-1" class="control-label">供应商编号</label>
				<input type="text" class="form-control" name="sn" placeholder="供应商编号" value="<?php echo uniqid(); ?>">
			</div>	
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				<label for="field-2" class="control-label">供应商名称</label>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="form-group">
				<label for="field-3" class="control-label">供应商地址</label>
