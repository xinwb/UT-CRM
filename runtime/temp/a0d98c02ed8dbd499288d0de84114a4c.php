...
<div class="page-title">  
    ...
    <div class="breadcrumb-env pull-left">
        ...
        <ol class="breadcrumb bc-1">
            <li>
                <a href="<?php echo url('Product/index'); ?>"><i class="fa-home"></i>首页</a>
            </li>
            <li>
                <a href="">基本设置</a>
             </li>
                    ...
                    <div class="btn-toolbar">
                        ...
                        <form class="form-inline" style="margin-bottom:15px;" class="search-tool">
                            <span>
                                ...
                                <input type="text" class="form-control" placeholder="物料名称" name="name" value="<?php echo \think\Request::instance()->get('name'); ?>"> 
                            </span>
                            
                            <span style="margin-left: 15px;">
                                <label class="control-label">物料编号</label>      
                                <input type="text" class="form-control" placeholder="物料编号" name="sn" value="<?php echo \think\Request::instance()->get('sn'); ?>">
                            </span>
                    ...
                    <table class="table table-bordered table-striped" id="example-2">
                        ...
                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td> <?php echo $user['speci']; ?> </td>
                                <!-- <td> <?php echo $user['storage']; ?> </td> -->
                                ...
                                <td>
                                    <a href="javascript:;" 
                                        ...
                                        onclick="editAjaxModal('<?php echo url('/Product/edit/id/'.$user->id); ?>')" >
                                        编辑
                                    </a>
...
<script type="text/javascript">
    ...
    function showAjaxModal(){
        ...
        jQuery.ajax({
            url: "<?php echo url('Product/create'); ?>",
    ...
    function add_from(){
        ...
        $.post("<?php echo url('Product/save'); ?>", res,function(data){
            if( data.error>0 ){
    ...
    function edit_from(){
        ...
        $.post("<?php echo url('Product/update'); ?>", res,function(data){
            if( data.error>0 ){
                toastr.error( data.msg );  
            }else{
                toastr.success( data.msg );  
    ...
    function del(id){
        if( confirm("确定要删除吗？") ){
            $.post("<?php echo url('Product/delete'); ?>", {id:id},function(data){
                if( data.error>0 ){
                    toastr.error( data.msg );  
                }else{
                    toastr.success( data.msg );  
