...
<div class="page-title">  
    ...
    <div class="breadcrumb-env pull-left">
        ...
        <ol class="breadcrumb bc-1">
            <li>
                <a href="<?php echo url('Instorage/index'); ?>"><i class="fa-home"></i>首页</a>
            </li>
            <li>
                <a href="">基本设置</a>
             </li>
                    ...
                    <div class="btn-toolbar">
                        ...
                        <form class="form-inline" style="margin-bottom:15px;" class="search-tool">
                            ...
                            <span style="margin-left: 15px;">
                                ...
                                <input type="text" class="form-control" placeholder="入库编号" name="sn" value="<?php echo \think\Request::instance()->get('sn'); ?>">
                            </span>
                            ...
                            <span style="margin-left: 15px;">
                                ...
                                <select class="form-control" name="type">
                                    ...
                                    >全部类型</option>
                                    <option value="采购入库"
                                        <?php if(\think\Request::instance()->get('type') == '采购入库'): ?> selected="selected" <?php endif; ?>
                                    >采购入库</option>
                                    <option value="销售退货"
...
<!--                                     <a href="javascript:;"
                                        ...
                                        onclick="editAjaxModal('<?php echo url('/Instorage/edit/id/'.$vo->id); ?>')" >
                                        编辑
                                    </a> -->

                                    <a href="<?php echo url('/Instorage/prints/id/'.$vo->id); ?>" target="_blank" class="btn btn-secondary btn-sm btn-icon icon-left">
                                        打印
                                    </a>

                                    <a href="javascript:;" class="btn btn-secondary btn-sm btn-icon icon-left" onclick="showModal('<?php echo url('/Instorage/show/id/'.$vo->id); ?>')">
                                        查看
                                    </a>
...
<script type="text/javascript">
    ...
    function showAjaxModal(){
        ...
        jQuery.ajax({
            url: "<?php echo url('Instorage/create'); ?>",
    ...
    function add_from(){
        ...
        $.post("<?php echo url('Instorage/save'); ?>", res,function(data){
            if( data.error>0 ){
    ...
    function edit_from(){
        ...
        $.post("<?php echo url('Instorage/update'); ?>", res,function(data){
            if( data.error>0 ){
                toastr.error( data.msg );
            }else{
                toastr.success( data.msg );
    ...
    function del(id){
        if( confirm("确定要删除吗？") ){
            $.post("<?php echo url('Instorage/delete'); ?>", {id:id},function(data){
                if( data.error>0 ){
                    toastr.error( data.msg );
                }else{
                    toastr.success( data.msg );
