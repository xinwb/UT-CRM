<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"D:\phpStudy\WWW\jxc\public/../app/view\outstorage\show.html";i:1514905474;}*/ ?>
    ...
    <div class="row">   
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="type" placeholder="出库类型" value="<?php echo $info['type']; ?>" disabled="disabled"> 
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
