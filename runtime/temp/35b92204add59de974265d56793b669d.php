<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\phpStudySetup\PHPTutorial\WWW\junyue\public/../app/view\product\create.html";i:1520045874;}*/ ?>
	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group">
				...
				<input type="text" class="form-control" name="sn" placeholder="产品编号" value="<?php echo uniqid(); ?>">
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="form-group">
				...
				<input type="text" class="form-control" name="nbsn" placeholder="内部编号" >
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group">
				...
				<input type="text" class="form-control" name="spec" placeholder="产品规格" value="">
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group">
				...
				<input type="text" class="form-control" name="price" placeholder="产品价格" >
			</div>
		</div>
	</div>
<!--
