            ...
            <div class="panel panel-default">
                <div class="panel-heading btn-toolbar">
                    ...
                    <div class="btn-group dropdown-btn-group pull-right">
                        ...
                        <form action="<?php echo url('Excel/insInto'); ?>" enctype="multipart/form-data" method="post">
                            <input  type="file" class="btn btn-default" name="file_stu"/>
                            <input type="submit" class="btn btn-default" value="导入" />
                        </form>
                        <form action="<?php echo url('Excel/insExport'); ?>" enctype="multipart/form-data" method="post" >
                    ...
                    <div class="btn-toolbar">
                        ...
                        <form class="form-inline" style="margin-bottom:15px;" class="search-tool">
                            ...
                            <span style="margin-left: 15px;">
                                ...
                                <input type="text" class="form-control" placeholder="入库单号" name="sn" value="<?php echo \think\Request::instance()->get('sn'); ?>">
                            </span>
