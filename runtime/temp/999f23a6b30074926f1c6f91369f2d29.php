<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpStudySetup\PHPTutorial\WWW\junyue\public/../app/view\instorage\create.html";i:1514905474;}*/ ?>
	...
	<div class="row">	
		<div class="col-md-12">
			<div class="form-group">
				...
				<input type="text" class="form-control" name="sn" placeholder="订单号" value="SN<?php echo date('Ymdhis',time()); ?><?php echo rand(10000,99999); ?>">
			</div>	
		</div>
            ...
            <tr role="row" class="odd order-list">
                ...
                <td> 
                    <select name="product[]" class="form-control">
                        ...
                        <option value="<?php echo $vo['sn']; ?>_<?php echo $vo['name']; ?>_<?php echo $vo['price']; ?>_<?php echo $vo['storage']; ?>_<?php echo $vo['unit']; ?>"><?php echo $vo['name']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select> 
                </td>
